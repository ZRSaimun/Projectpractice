...
class sellController extends Controller
{
    public function reviewProductView(Request $request)
    {
        ...
        return view('retailseller.reviewProductList')->with('product', $product);
    }
    public function reviewProductDetails(Request $request, string $slug)
    {
        ...
        return view('retailseller.reviewProductDetails')->with('orderList', $orderList);
        //echo $orderList;
    }
    ...
    public function totalIncomeView(Request $request)
    {
        ...
        //echo $product;
        //return view('retailseller.addProduct', compact($catagoryID));
        return view('retailseller.totalIncomeList')->with('product', $product);
    }
    public function totalIncomeDetails(Request $request, string $slug)
    {
        ...
        return view('retailseller.totalIncomeDetails')->with('orderList', $orderList);
        //echo $orderList;
    }
    ...
    public function deliveredOrderView(Request $request)
    {
        ...
        //return view('retailseller.addProduct', compact($catagoryID));
        //echo $orderList;
        return view('retailseller.productListdelivered')->with('orderList', $orderList);
    }
    ...
    public function pendingOrderView(Request $request)
    {
        ...
        //return view('retailseller.addProduct', compact($catagoryID));
        //echo $orderList;
        return view('retailseller.productListPending')->with('orderList', $orderList);
    }
    ...
    public function reportCustomerView(Request $request)
    {
        ...
        //return view('retailseller.addProduct', compact($catagoryID));
        //echo $orderList;
        return view('retailseller.reportCustomerList')->with('orderList', $orderList);
    }
    public function reportCustomerDetails(Request $request, string $slug)
    {
        ...
        return view('retailseller.reportCustomerDetails')->with('orderList', $orderList);
        //echo $orderList;
    }
