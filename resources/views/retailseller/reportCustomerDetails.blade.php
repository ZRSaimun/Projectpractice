          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Report Product</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td> Customer ID</td>
                    <td>:</td>
                    <td><span>{{$items->customer_id}}</span>
                      <input type="hidden" name="customerID" value="{{$items->customer_id}}"></td>
                      <tr>
                    ...
                    <tr>
                        ...
                        <td width="10%"></td>
                        <td width="55%">
                            <textarea name="report" id="report" cols="70" rows="03"></textarea>
